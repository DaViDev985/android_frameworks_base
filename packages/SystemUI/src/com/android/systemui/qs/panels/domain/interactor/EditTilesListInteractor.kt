...
constructor(
    ...
    private val customTileMap: Map<String, CustomTileConfig> = mapOf(
        ...
        "dataswitch" to CustomTileConfig(R.drawable.ic_qs_data_switch_1, R.string.qs_data_switch_label, TileCategory.CONNECTIVITY),
        "preferred_network" to CustomTileConfig(R.drawable.ic_preferred_network, R.string.quick_settings_preferred_network_label, TileCategory.CONNECTIVITY),
        "dns" to CustomTileConfig(R.drawable.ic_settings_dns, com.android.settingslib.R.string.select_private_dns_configuration_title, TileCategory.CONNECTIVITY),
        ...
        "cpuinfo" to CustomTileConfig(R.drawable.ic_qs_cpu_info, R.string.quick_settings_cpuinfo_label, TileCategory.UTILITIES),
        "compass" to CustomTileConfig(R.drawable.ic_qs_compass, R.string.quick_settings_compass_label, TileCategory.UTILITIES),
        "locale" to CustomTileConfig(R.drawable.ic_qs_locale, R.string.quick_settings_locale_label, TileCategory.UTILITIES),
        "screenshot" to CustomTileConfig(android.R.drawable.ic_menu_camera, R.string.screenshot_long_press, TileCategory.UTILITIES),
        "sound" to CustomTileConfig(R.drawable.ic_qs_ringer_audible, R.string.quick_settings_sound_label, TileCategory.UTILITIES),
        "music" to CustomTileConfig(R.drawable.ic_default_music_icon, R.string.quick_settings_music_label, TileCategory.UTILITIES),
        "derpfest" to CustomTileConfig(R.drawable.ic_qs_derpfest, R.string.quick_derpfest_label, TileCategory.UTILITIES),
